 ...
 * 搜索历史RecyclerView适配器
 */
class SearchHistoryAdapter(private val mContext: Context, private val mSearchHistoryList: Set<String>) : RecyclerView.Adapter<SearchHistoryAdapter.SearchHistoryHolder>() {
    ...
    inner class SearchHistoryHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setData(position: Int) {
            val searchHistory = mSearchHistoryList.elementAt(position)
